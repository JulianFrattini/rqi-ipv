...
The results contradict the conclusions of the original study. If we plot the marginal effects of missing actors and domain objects, we see that these also have a slight impact on the number of missing associations.
